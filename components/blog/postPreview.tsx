...
export default function PostPreview(props: PostMetadata) {
  return (
    <Link  
      ...
      className="flex flex-col p-3 space-y-2 transition-colors bg-gray-200 bg-opacity-50 border border-transparent rounded-md min-w-32 sm:space-y-0 sm:space-x-8 sm:flex-row dark:bg-gray-700 hover:bg-transparent hover:border hover:border-gray-200 dark:hover:border-gray-700">
